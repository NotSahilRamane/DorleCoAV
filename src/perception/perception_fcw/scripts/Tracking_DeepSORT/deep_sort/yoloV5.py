...
class YOLO_Fast(): # outputs tlbr bounding boxes
    ...
    def __init__(self, sc_thresh=.5, nms_thresh=.45, cnf_thresh=.45, model="/home/dorleco/DorleCoAV/src/perception/object_tracking/scripts/Tracking_DeepSORT/deep_sort/onnx_models/yolov5s.onnx"):
        ...
        # Network & Classes
        classesFile = "/home/reuben/Projects/FCW-AEB/DorleCoAV/src/perception/perception_fcw/scripts/Tracking_DeepSORT/data/labels/coco.names"
        self.classes = None
